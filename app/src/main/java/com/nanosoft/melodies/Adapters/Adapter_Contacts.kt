...
import com.nanosoft.melodies.Activties.Activity_ContactsChoice
import com.nanosoft.melodies.R
import com.nanosoft.melodies.Adapters.Adapter_Contacts.ItemHolder
import kotlinx.android.synthetic.main.item_contacts.view.*
import java.util.*


class Adapter_Contacts(private val mActivityContactsChoice: Activity_ContactsChoice, private var mData: ArrayList<com.nanosoft.melodies.Models.Contacts>?) : RecyclerView.Adapter<ItemHolder>() {
    ...
    fun updateData(data: ArrayList<com.nanosoft.melodies.Models.Contacts>) {
        this.mData = data
