...
package com.nanosoft.melodies.SoundEditor;


import com.nanosoft.melodies.UILapplication;
import com.nanosoft.melodies.Models.SelectionPoint;
...
public class CheapSoundFile {
    ...
    private static final Factory[] sSubclassFactories = new Factory[]{
            com.nanosoft.melodies.SoundEditor.CheapAAC.getFactory(),
            com.nanosoft.melodies.SoundEditor.CheapAMR.getFactory(),
            com.nanosoft.melodies.SoundEditor.CheapMP3.getFactory(),
            com.nanosoft.melodies.SoundEditor.CheapWAV.getFactory(),
    };
    ...
    public void writewavfile(File outputFile, int startFrame, int numFrames, boolean fadeIn, boolean fadeOut, int fadeTime)
        ...
        com.nanosoft.melodies.SoundEditor.CheapAAC cheap = (com.nanosoft.melodies.SoundEditor.CheapAAC) this;
    ...
    public void WriteFile(File outputFile, int startFrame, int numFrames, boolean fadeIn, boolean fadeOut, int fadeTime)
        ...
        if (this instanceof com.nanosoft.melodies.SoundEditor.CheapAAC) {
            com.nanosoft.melodies.SoundEditor.CheapAAC cheap = (com.nanosoft.melodies.SoundEditor.CheapAAC) this;
            cheap.WriteFile(outputFile, startFrame, numFrames, fadeIn, fadeOut, fadeTime);
        } else if (this instanceof com.nanosoft.melodies.SoundEditor.CheapAMR) {
            com.nanosoft.melodies.SoundEditor.CheapAMR cheap = (CheapAMR) this;
            cheap.WriteFile(outputFile, startFrame, numFrames, fadeIn, fadeOut, fadeTime);
        } else if (this instanceof com.nanosoft.melodies.SoundEditor.CheapMP3) {
            com.nanosoft.melodies.SoundEditor.CheapMP3 cheap = (CheapMP3) this;
            cheap.WriteFile(outputFile, startFrame, numFrames, fadeIn, fadeOut, fadeTime);
        } else if (this instanceof com.nanosoft.melodies.SoundEditor.CheapWAV) {
            com.nanosoft.melodies.SoundEditor.CheapWAV cheap = (CheapWAV) this;
            cheap.WriteFile(outputFile, startFrame, numFrames, fadeIn, fadeOut, fadeTime);
        }
    }
