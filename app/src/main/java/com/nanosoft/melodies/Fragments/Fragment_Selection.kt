...
import com.nanosoft.melodies.ViewHolders.Viewholder_SelectionItem
import com.nanosoft.melodies.Models.MusicFile
import kotlinx.android.synthetic.main.fragment_selection.*
import org.greenrobot.eventbus.EventBus
import org.greenrobot.eventbus.Subscribe
import org.greenrobot.eventbus.ThreadMode
import com.nanosoft.melodies.Adapters.Adapter_Selection
...
class Fragment_Selection : Fragment(), PopupMenu.OnMenuItemClickListener {
    ...
    private var dbHelper: com.nanosoft.melodies.Database.DBHelper? = null
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        dbHelper = com.nanosoft.melodies.Database.DBHelper.getInstance(activity)
    ...
    private fun ShowEmptyStatus() {
        ...
        com.nanosoft.melodies.Views.LeftWaveInView.doWaveInAnimForView(OvershootInterpolator(), 2050, no_data_text2, true)
    }
    ...
    fun onMessageEvent(event: com.nanosoft.melodies.Entities.WaveFormCompletionEvent) {
