...
import com.nanosoft.melodies.Activties.Activity_Main
...
class Fragment_Setting : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater?, container: ViewGroup?,
        ...
        view.selectFile.setOnClickListener {
            val activityMain = activity as Activity_Main
            activityMain.ChangeFragment(false)
        }
