...
import com.nanosoft.melodies.Adapters.Adapter_Contacts
import com.nanosoft.melodies.Utils.PermissionManger
import java.util.*
...
class Activity_ContactsChoice : AppCompatActivity(), SearchView.OnQueryTextListener {
    ...
    private var mData: ArrayList<com.nanosoft.melodies.Models.Contacts>? = null
    ...
    companion object {
        ...
        fun getContacts(context: Context, searchQuery: String): ArrayList<com.nanosoft.melodies.Models.Contacts> {

            val selection = "(DISPLAY_NAME LIKE \"%$searchQuery%\")"

            val contactsModels = ArrayList<com.nanosoft.melodies.Models.Contacts>()
            ...
            if (cursor != null && cursor.moveToFirst()) {
                do {
                    val contactsModel = com.nanosoft.melodies.Models.Contacts(cursor.getString(2),
