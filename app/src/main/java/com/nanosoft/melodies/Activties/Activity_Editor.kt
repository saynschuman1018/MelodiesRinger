...
import com.nanosoft.melodies.SoundEditor.MarkerView
import com.nanosoft.melodies.Models.MusicType
...
class Activity_Editor : AppCompatActivity(), MarkerView.MarkerListener, com.nanosoft.melodies.SoundEditor.WaveformView.WaveformListener, View.OnClickListener {
    ...
    private var mSoundFile: com.nanosoft.melodies.SoundEditor.CheapSoundFile? = null
    private var mFile: File? = null
    private var mFilename: String? = null
    private var mWaveformView: com.nanosoft.melodies.SoundEditor.WaveformView? = null
    ...
    private fun loadFromFile() {
        ...
        object : Thread() {
            override fun run() {
                try {
                    mSoundFile = com.nanosoft.melodies.SoundEditor.CheapSoundFile.create(mFile!!.absolutePath, listener)
                } catch (e: Exception) {
    ...
    private fun afterSavingRingtone(title: CharSequence, outPath: String?, duration: Int, endpoint: Double) {
        ...
        when (mNewFileKind) {
            FILE_KIND_NOTIFICATION -> {
                ...
                Songtype = com.nanosoft.melodies.Utils.Constants.NOTIFICATION_KEY
            ...
            FILE_KIND_RINGTONE -> {
                ...
                Songtype = com.nanosoft.melodies.Utils.Constants.RINGTONE_KEY
            ...
            FILE_KIND_ALARM -> {
                ...
                Songtype = com.nanosoft.melodies.Utils.Constants.ALARM_KEY
